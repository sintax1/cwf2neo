...
.PHONY: clean-pyc clean-build docs pre-build docker-build post-build build docker-release patch-release minor-release major-release tag check-status check-release showver \
...
docker-release: check-status check-release build push
